from . import train
from . import translate as mosestranslate
...
def tune_smt(self, l1, l2, translator_id, bitext_id):
  ...
  translator = TranslatorFromBitext.query.get(translator_id)

  tmpdir = train.training_dir_setup_tuning(l1, l2, translator.get_path()[0], path1, path2 )
